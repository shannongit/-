						...
						$.ajax({
							...
							success: function(data) {
								...
								for(var q = 0; q < js.length; q++) {
									...
									trend1 += '<td class="bianhao" title="点击查看台账详细信息" id="' + js[q].PoleID + '" >' + js[q].PoleName + '</td>'
									trend1 += '<td>' + js[q].clockNum + '</td>'
									trend1 += '<td class="Add">' + '存' + '</td>'
									trend1 += '<td class="Selch">' + '查' + '</td>'
									trend1 += '<td class="SelchVideo">' + '视频' + '</td>'
									trend1 += '<td class="AddQJT"><a href="panorama.html">添加全景图</a></td>'
								...
								$(document.body).on('click', '.Selch', function functionqqq() {
									...
									$.ajax({
										//url: 'http://192.168.1.41:1337/peopleLineList',
										url: url + 'polePhoto' + '/' + js[Selchindex].PoleID,
										//data: "127605d5-ee91-4557-a7fe-fb096918b6bc",
										type: 'get',
										dataType: 'json',
										success: function(data) {
								...
								$(document.body).on('click', '.SelchVideo', function() {
									...
									$.ajax({
										//url: 'http://192.168.1.41:1337/peopleLineList',
										url: url + 'poleVideo' + '/' + js[SelchVideoindex].PoleID,
										//data: "127605d5-ee91-4557-a7fe-fb096918b6bc",
										type: 'get',
										dataType: 'json',
										success: function(data) {
