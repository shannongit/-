...
//----------------------------UPLOADFILES------------------------------------
    ...
    Ssi_upload.prototype.uploadFiles = function () {// upload the pending files
        if (this.pending > 0) {
            ...
            formData.append("upfile",document.getElementById("ssi-upload").files[0]);
		    formData.append("poleId",'A2EF6173844B4620825CCA786A1DBF6C21030100001');
		    formData.append("lineId",1053);
        ...
        function ajaxLoopRequest(formData, ii) {
            ...
            var ajaxOptions = $.extend({}, {//store the request to the uploadList variable
                ...
                contentType: false,
                processData: false,
                url:"http://117.27.139.39:4322/polePhoto",
...
//                      console.log(url)
    ...
    var locale = {
        en: {
            ...
            extError: '$1 文件类型不被支持，请选择正确格式的文件',//$1=file extension ie(exe files are not supported)
